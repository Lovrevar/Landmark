/*
  # Add VAT rate and amount fields to get_filtered_invoices

  1. Changes
    - Add vat_rate_1, vat_rate_2, vat_rate_3, vat_rate_4 to RETURNS TABLE and SELECT
    - Add vat_amount_1, vat_amount_2, vat_amount_3, vat_amount_4 to RETURNS TABLE and SELECT

  2. Purpose
    - Fix invoice table and detail view showing 0 for PDV amounts
    - The vat_amount fields exist in the accounting_invoices table but were not being returned by the function
*/
