/*
  # Fix get_filtered_invoices column names

  1. Changes
    - Fixes column names to match actual accounting_invoices table schema
    - Removes non-existent columns: payment_method, bank_account_id, credit_id, retail_phase_id, bank_iban
    - Uses correct names: iban, company_bank_account_id, bank_credit_id
*/
