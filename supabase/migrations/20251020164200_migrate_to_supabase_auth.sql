...
-- VAŽNE NAPOMENE:
--
-- 1. Nakon pokretanja ove migracije, potrebno je kreirati inicijalnog Admin korisnika
--    kroz Supabase Dashboard ili SQL INSERT u auth.users tabelu
--
-- 2. Login format će biti: email = "admin@landmark.local", password = "admin123"
--    (ili šta god odabereš)
--
-- 3. Aplikacija treba da se ažurira da koristi supabase.auth.signInWithPassword()
--    umjesto custom login logike
--
-- 4. Svi postojeći podaci ostaju netaknuti osim users tabele koja gubi password kolonu
--
