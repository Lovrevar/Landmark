/*
  # Add refund data to get_filtered_invoices function

  1. Changes
    - Add refund_id and refund_name to RETURNS TABLE
    - Add LEFT JOIN with accounting_invoices_refund table
    - Include refund data in SELECT statement

  2. Purpose
    - Allow frontend to display refund information in invoice list
    - Show which invoices have refunds assigned
*/
