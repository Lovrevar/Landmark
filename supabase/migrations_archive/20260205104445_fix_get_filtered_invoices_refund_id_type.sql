/*
  # Fix refund_id type in get_filtered_invoices

  1. Changes
    - Change refund_id from integer to bigint in RETURNS TABLE
    - This matches the actual data type in accounting_invoices table

  2. Purpose
    - Fix type mismatch error when fetching invoices with refund data
*/
