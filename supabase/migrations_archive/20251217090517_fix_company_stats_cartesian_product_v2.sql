/*
  # Fix Company Statistics View - Eliminate Cartesian Product (v2)

  1. Problem
    - Multiple LEFT JOINs cause Cartesian product
    - Bank account count multiplies invoice amounts
    - Example: 2 bank accounts + 1 invoice = amounts counted 2x
      CURIS: €62,500 shown as €125,000
      MATARA: €10,000 shown as €20,000

  2. Solution
    - Replace LEFT JOINs with LATERAL subqueries
    - Each aggregation is independent
    - No more duplicate counting

  3. Changes
    - Bank accounts: separate LATERAL subquery
    - Credits: separate LATERAL subquery
    - Invoices: keep as main query but aggregate properly
*/
