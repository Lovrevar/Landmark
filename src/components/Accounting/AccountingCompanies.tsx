            ...
            <div className="overflow-y-auto flex-1 p-6">
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-blue-900">€{selectedCompany.initial_balance.toLocaleString('hr-HR')}</p>
                </div>
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-red-900">€{selectedCompany.total_expense_paid.toLocaleString('hr-HR')}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className={`text-2xl font-bold ${selectedCompany.current_balance >= 0 ? 'text-green-900' : 'text-red-900'}`}>
                    €{selectedCompany.current_balance.toLocaleString('hr-HR')}
                  </p>
                </div>
