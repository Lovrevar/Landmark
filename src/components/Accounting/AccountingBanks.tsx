        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">€{totalUsedAcrossAllBanks.toLocaleString()}</p>
            </div>
              ...
              <div key={bank.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-lg font-bold text-blue-900">€{bank.total_used.toLocaleString()}</p>
                  </div>
