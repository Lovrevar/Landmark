    ...
    if (invoice) {
      if (invoice.invoice_category === 'RETAIL') {
        ...
        setFormData({
          ...
          base_amount_1: parseFloat(String(invoice.base_amount_1 || 0)),
          base_amount_2: parseFloat(String(invoice.base_amount_2 || 0)),
          base_amount_3: parseFloat(String(invoice.base_amount_3 || 0)),
          base_amount_4: parseFloat(String(invoice.base_amount_4 || 0)),
