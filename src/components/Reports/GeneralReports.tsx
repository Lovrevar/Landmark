    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-blue-900">{t('reports.general.exec_summary')}</h2>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-2xl font-bold text-blue-900 mb-6">{t('reports.general.kpi_title')}</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl text-center border border-blue-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.portfolio_value')}</p>
          </div>
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl text-center border border-green-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.total_revenue')}</p>
          </div>
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-6 rounded-xl text-center border border-teal-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.net_profit')}</p>
          </div>
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl text-center border border-orange-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.roi')}</p>
          </div>
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-6 rounded-xl text-center border border-teal-200">
            <p className="text-3xl font-bold text-teal-600">{report.kpis.sales_rate.toFixed(1)}%</p>
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.sales_rate')}</p>
          </div>
          <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-6 rounded-xl text-center border border-pink-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.de_ratio')}</p>
          </div>
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-xl text-center border border-slate-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.active_projects')}</p>
          </div>
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 rounded-xl text-center border border-yellow-200">
            ...
            <p className="text-sm text-gray-600 mt-2">{t('reports.general.total_customers')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-sm border border-green-200 p-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-green-900">{t('reports.general.sales_performance')}</h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
          <div><p className="font-bold text-gray-700">{t('reports.general.total_units_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.total_units}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.units_sold_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.units_sold} ({((report.sales_performance.units_sold / report.sales_performance.total_units) * 100).toFixed(1)}%)</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.available_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.available_units}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.reserved_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.reserved_units}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.total_revenue_label')}</p><p className="text-xl font-bold text-gray-900">€{report.sales_performance.total_revenue.toLocaleString()}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.avg_sale_price_label')}</p><p className="text-xl font-bold text-gray-900">€{report.sales_performance.avg_sale_price.toLocaleString()}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.total_sales_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.total_sales}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.buyers_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.buyers}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.active_leads_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.active_leads}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.conversion_rate_label')}</p><p className="text-xl font-bold text-gray-900">{report.sales_performance.conversion_rate.toFixed(1)}%</p></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl shadow-sm border border-teal-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-teal-900">{t('reports.general.funding_structure')}</h2>
          </div>
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow-sm border border-orange-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-orange-900">{t('reports.general.construction_status')}</h2>
          </div>
          <div className="space-y-3 text-sm">
            {[
      ...
      <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl shadow-sm border border-cyan-200 p-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-cyan-900">{t('reports.general.accounting_overview')}</h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div><p className="font-bold text-gray-700">{t('reports.general.total_invoices')}</p><p className="text-xl font-bold text-gray-900">{report.accounting_overview.total_invoices}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.total_invoice_value')}</p><p className="text-xl font-bold text-gray-900">€{(report.accounting_overview.total_invoice_value / 1000000).toFixed(2)}M</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.paid_invoices')}</p><p className="text-xl font-bold text-green-600">{report.accounting_overview.paid_invoices} (€{(report.accounting_overview.paid_value / 1000000).toFixed(2)}M)</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.pending_invoices')}</p><p className="text-xl font-bold text-yellow-600">{report.accounting_overview.pending_invoices} (€{(report.accounting_overview.pending_value / 1000000).toFixed(2)}M)</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.overdue_invoices')}</p><p className="text-xl font-bold text-red-600">{report.accounting_overview.overdue_invoices} (€{(report.accounting_overview.overdue_value / 1000000).toFixed(2)}M)</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.payment_completion')}</p><p className="text-xl font-bold text-gray-900">{report.accounting_overview.payment_completion_rate.toFixed(1)}%</p></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl shadow-sm border border-amber-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-amber-900">{t('reports.general.office_expenses')}</h2>
          </div>
          <div className="space-y-3 text-sm">
            {[
        ...
        <div className="bg-gradient-to-br from-rose-50 to-rose-100 rounded-xl shadow-sm border border-rose-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-rose-900">{t('reports.general.company_investments')}</h2>
          </div>
          <div className="space-y-3 text-sm">
            {([
              ...
              <div key={i} className="flex justify-between">
                <span className="font-bold text-gray-700">{label}</span>
                <span className={`font-bold ${isGreen ? 'text-green-600' : 'text-gray-900'}`}>{value}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-slate-900">{t('reports.general.bank_accounts')}</h2>
          </div>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between"><span className="font-bold text-gray-700">{t('reports.general.total_bank_accounts')}</span><span className="font-bold text-gray-900">{report.bank_accounts.total_accounts}</span></div>
            <div className="flex justify-between"><span className="font-bold text-gray-700">{t('reports.general.total_balance')}</span><span className={`font-bold ${report.bank_accounts.total_balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>€{report.bank_accounts.total_balance.toLocaleString()}</span></div>
            <div className="flex justify-between"><span className="font-bold text-gray-700">{t('reports.general.positive_accounts')}</span><span className="font-bold text-green-600">{report.bank_accounts.positive_balance_accounts}</span></div>
            <div className="flex justify-between"><span className="font-bold text-gray-700">{t('reports.general.negative_accounts')}</span><span className="font-bold text-red-600">{report.bank_accounts.negative_balance_accounts}</span></div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl shadow-sm border border-teal-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold text-teal-900">{t('reports.general.buildings_units')}</h2>
          </div>
          <div className="space-y-3 text-sm">
            {([
              ...
              <div key={i} className="flex justify-between">
                <span className="font-bold text-gray-700">{label}</span>
                <span className={`font-bold ${color === 'green' ? 'text-green-600' : color === 'yellow' ? 'text-yellow-600' : 'text-gray-900'}`}>{value}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-sm border border-green-200 p-6">
        <div className="flex items-center mb-4">
          <Home className="w-6 h-6 text-green-600 mr-2" />
          <h2 className="text-2xl font-bold text-green-900">{t('reports.general.retail_portfolio')}</h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
          <div><p className="font-bold text-gray-700">{t('reports.general.retail_projects')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.total_retail_projects}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.active_retail_projects')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.active_retail_projects}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.land_plots')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.total_land_plots}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.retail_contracts')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.total_retail_contracts}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.contract_value_retail')}</p><p className="text-xl font-bold text-gray-900">€{report.retail_portfolio.retail_contract_value.toLocaleString()}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.budget_realized_retail')}</p><p className="text-xl font-bold text-gray-900">€{report.retail_portfolio.retail_budget_realized.toLocaleString()}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.retail_phases')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.retail_phases}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.completed_retail_phases')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.completed_retail_phases}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.retail_customers')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.total_retail_customers}</p></div>
          <div><p className="font-bold text-gray-700">{t('reports.general.retail_suppliers')}</p><p className="text-xl font-bold text-gray-900">{report.retail_portfolio.retail_suppliers}</p></div>
        </div>
      </div>
      ...
      {report.contract_types.length > 0 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900">{t('reports.general.contract_types')}</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{t('reports.general.cash_flow')}</h2>
        </div>
        <Table>
          <Table.Head>
            <Table.Tr>
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          <p className="font-bold text-gray-900">{t('reports.general.six_month_totals')}</p>
      ...
      {report.projects.length > 0 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('reports.general.project_breakdown')}</h2>
          <div className="space-y-4">
            {report.projects.map((project) => (
              <div key={project.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div><p className="text-gray-600">{t('reports.general.status_label')}</p><p className="font-bold text-gray-900">{project.status}</p></div>
                  <div><p className="text-gray-600">{t('reports.general.budget_label')}</p><p className="font-bold text-gray-900">€{project.budget.toLocaleString()}</p></div>
                  <div><p className="text-gray-600">{t('reports.general.revenue_label')}</p><p className="font-bold text-green-600">€{project.revenue.toLocaleString()}</p></div>
                  <div><p className="text-gray-600">{t('reports.general.expenses_label')}</p><p className="font-bold text-red-600">€{project.expenses.toLocaleString()}</p></div>
                  <div><p className="text-gray-600">{t('reports.general.units_label')}</p><p className="font-bold text-gray-900">{project.units_sold}/{project.total_units} sold ({project.sales_rate.toFixed(1)}%)</p></div>
                  <div><p className="text-gray-600">{t('reports.general.contracts_label')}</p><p className="font-bold text-gray-900">{project.contracts}</p></div>
                  <div><p className="text-gray-600">{t('reports.general.phases_label')}</p><p className="font-bold text-gray-900">{project.phases_done}/{project.total_phases} done</p></div>
                  <div><p className="text-gray-600">{t('reports.general.funding_label')}</p><p className="font-bold text-gray-900">€{project.equity.toLocaleString()} equity, €{project.debt.toLocaleString()} debt</p></div>
                </div>
              </div>
            ))}
          </div>
      ...
      {report.risks.length > 0 && (
        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl shadow-sm border border-red-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-2xl font-bold text-red-900">{t('reports.general.risk_assessment')}</h2>
          </div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-sm border border-green-200 p-6">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-green-900">{t('reports.general.insights')}</h2>
        </div>

        <div className="mb-6">
          <h3 className="text-lg font-bold text-gray-900 mb-3">{t('reports.general.top_projects')}</h3>
          <ul className="space-y-2">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-900 mb-3">{t('reports.general.recommendations')}</h3>
          <ul className="space-y-2">
