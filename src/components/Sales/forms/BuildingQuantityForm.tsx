...
interface BuildingQuantityFormProps {
  visible: boolean
  onClose: () => void
  onSubmit: (quantity: number) => void
}

const BuildingQuantityForm: React.FC<BuildingQuantityFormProps> = ({ visible, onClose, onSubmit }) => {
...
export default BuildingQuantityForm
