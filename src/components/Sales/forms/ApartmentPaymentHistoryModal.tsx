...
import { ApartmentPayment } from '../../../lib/supabase'

interface ApartmentPaymentHistoryModalProps {
  visible: boolean
  onClose: () => void
...
export const ApartmentPaymentHistoryModal: React.FC<ApartmentPaymentHistoryModalProps> = ({
  visible,
  onClose,
  apartmentNumber,
  salePrice,
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">€{salePrice.toLocaleString()}</p>
              </div>
              <div>
