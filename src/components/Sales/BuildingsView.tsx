...
import type { ProjectWithBuildings, BuildingWithUnits } from './types/salesTypes'
...
interface BuildingsViewProps {
  ...
  onShowAddBuilding: () => void
  onShowAddMultiple: () => void
}

const BuildingsView: React.FC<BuildingsViewProps> = ({
  project,
  onBack,
  onSelectBuilding,
  onDeleteBuilding
