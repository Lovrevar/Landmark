          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1 cursor-pointer" onClick={() => onSelectBuilding(building)}>
                ...
                <p className="text-sm text-gray-600">{building.total_floors} {t('sales_projects.floors')}</p>
              </div>
              <button
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600">{t('sales_projects.units.apartments')}</p>
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600">{t('sales_projects.units.garages')}</p>
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600">{t('sales_projects.units.repositories')}</p>
