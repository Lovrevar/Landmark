          ...
          >
            <div className="flex items-start justify-between mb-6">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-gray-600">{t('funding.projects.total_budget_label')}</p>
            ...
            <StatGrid columns={4} className="mb-4">
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-green-700">{t('funding.projects.equity_investment_label')}</span>
              ...
              <div className="bg-red-50 p-4 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-red-700">{t('funding.projects.debt_financing_label')}</span>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-blue-700">{t('funding.projects.expected_roi_label')}</span>
              ...
              <div className="bg-teal-50 p-4 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-teal-700">{t('funding.projects.funding_status_label')}</span>
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-2">
                <span className="text-sm text-gray-600">{t('funding.projects.total_funding_progress')}</span>
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">{t('funding.projects.funders_label')}</span>
                <Building2 className="w-4 h-4 text-gray-400" />
              </div>
              <div className="space-y-1">
                {project.banks.length === 0 ? (
                  <p className="text-xs text-gray-500">{t('funding.projects.no_financing_sources')}</p>
                ) : (
                ...
                {project.banks.length > 3 && (
                  <p className="text-xs text-gray-500">{t('funding.projects.more_funders', { count: project.banks.length - 3 })}</p>
                )}
              </div>
            </div>
          </div>
