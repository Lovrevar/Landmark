          ...
          <Card key={contract.id} variant="bordered" padding="md">
            ...
            {hasValidContract ? (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm mb-3">
                <div>
                  <p className="text-gray-600">{t('common.contract')}:</p>
                ...
                <div>
                  <p className="text-gray-600">{t('common.remaining')}:</p>
                  <p className="font-medium text-orange-600">{formatEuro(contract.cost - contract.budget_realized)}</p>
                </div>
                {contract.deadline && (
                  <div>
                    <p className="text-gray-600">{t('supervision.contract_fields.deadline')}:</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm mb-3">
                <div>
                  <p className="text-gray-600">{t('supervision.subcontractors.value')}:</p>
