...
import { EnhancedApartment, EnhancedGarage, EnhancedRepository } from '../../types'

interface LinkingModalProps {
  isOpen: boolean
  apartment: EnhancedApartment | null
  availableGarages: EnhancedGarage[]
  availableRepositories: EnhancedRepository[]
  onClose: () => void
              ...
              {availableGarages.map((garage) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">
                    Floor {garage.floor} • {garage.size_m2}m²
                  </div>
                  <div className="text-sm font-medium text-orange-600">
                    €{garage.price.toLocaleString()}
                  </div>
                </button>
              ))}
            ...
            <div className="grid grid-cols-2 gap-3">
              {availableRepositories.map((repository) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">
                    Floor {repository.floor} • {repository.size_m2}m²
                  </div>
                  <div className="text-sm font-medium text-purple-600">
                    €{repository.price.toLocaleString()}
                  </div>
                </button>
              ))}
