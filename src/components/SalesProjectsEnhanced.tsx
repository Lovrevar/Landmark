...
const SalesProjectsEnhanced: React.FC = () => {
  ...
  const [selectedApartmentForPayment, setSelectedApartmentForPayment] = useState<Apartment | null>(null)
  const [apartmentPayments, setApartmentPayments] = useState<any[]>([])
  const [wirePaymentData, setWirePaymentData] = useState({
    amount: 0,
  ...
  const handleOpenWirePayment = (apartment: Apartment) => {
  ...
  const handleWirePayment = async () => {
    if (!selectedApartmentForPayment || wirePaymentData.amount <= 0) {
    ...
    try {
      const { error } = await supabase
        ...
        .insert({
          ...
          amount: wirePaymentData.amount,
          payment_date: wirePaymentData.payment_date,
          notes: wirePaymentData.notes
        })
  ...
  const handleOpenPaymentHistory = async (apartment: Apartment) => {
    setSelectedApartmentForPayment(apartment)
  ...
  const handleDeletePayment = async (paymentId: string) => {
    ...
    try {
      ...
      handleOpenPaymentHistory(selectedApartmentForPayment!)
      fetchData()
    } catch (error) {
  ...
  const handleOpenSaleDetails = (apartment: Apartment) => {
    setSelectedApartmentForPayment(apartment)
  ...
  return (
    <div>
              ...
              return (
                ...
                >
                  ...
                  <div className="border-t pt-3">
                    ...
                    {unit.status === 'Sold' && activeUnitType === 'apartment' && (
                      <div className="space-y-2 mt-2">
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            onClick={() => handleOpenWirePayment(unit)}
                          ...
                          <button
                            onClick={() => handleOpenPaymentHistory(unit)}
                            className="px-3 py-2 bg-teal-600 text-white rounded-md text-xs font-medium hover:bg-teal-700 transition-colors duration-200"
                          >
                            Payments
                          </button>
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            onClick={() => handleOpenSaleDetails(unit)}
      ...
      {/* Wire Payment Modal */}
      {showWirePaymentModal && selectedApartmentForPayment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Unit {selectedApartmentForPayment.number} - {(selectedApartmentForPayment as any).sale_info?.buyer_name}
              </p>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  type="number"
                  min="0"
                  value={wirePaymentData.amount}
                  onChange={(e) => setWirePaymentData({ ...wirePaymentData, amount: parseFloat(e.target.value) || 0 })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="date"
                  value={wirePaymentData.payment_date}
                  onChange={(e) => setWirePaymentData({ ...wirePaymentData, payment_date: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Notes</label>
                <textarea
                  value={wirePaymentData.notes}
                  onChange={(e) => setWirePaymentData({ ...wirePaymentData, notes: e.target.value })}
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      {showPaymentHistoryModal && selectedApartmentForPayment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
      ...
      {/* Sale Details Modal */}
      {showSaleDetailsModal && selectedApartmentForPayment && (selectedApartmentForPayment as any).sale_info && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{selectedApartmentForPayment.number}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Floor</p>
                  <p className="font-semibold text-gray-900">{selectedApartmentForPayment.floor}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Size</p>
                  <p className="font-semibold text-gray-900">{selectedApartmentForPayment.size_m2}m²</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Buyer</p>
                  <p className="font-semibold text-gray-900">{(selectedApartmentForPayment as any).sale_info.buyer_name}</p>
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-bold text-green-700">€{(selectedApartmentForPayment as any).sale_info.sale_price.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Payment Method</p>
                    <p className="font-semibold text-gray-900 capitalize">{(selectedApartmentForPayment as any).sale_info.payment_method.replace('_', ' ')}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Down Payment</p>
                    <p className="font-semibold text-gray-900">€{(selectedApartmentForPayment as any).sale_info.down_payment.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Total Paid</p>
                    <p className="font-semibold text-teal-700">€{(selectedApartmentForPayment as any).sale_info.total_paid.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Remaining</p>
                    <p className="font-semibold text-orange-600">€{(selectedApartmentForPayment as any).sale_info.remaining_amount.toLocaleString()}</p>
                  </div>
                  {(selectedApartmentForPayment as any).sale_info.monthly_payment > 0 && (
                    <div>
                      <p className="text-sm text-gray-600">Monthly Payment</p>
                      <p className="font-semibold text-gray-900">€{(selectedApartmentForPayment as any).sale_info.monthly_payment.toLocaleString()}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <p className="text-sm font-medium">
                    {((selectedApartmentForPayment as any).sale_info.total_paid / (selectedApartmentForPayment as any).sale_info.sale_price * 100).toFixed(1)}%
                  </p>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{
                      width: `${Math.min(((selectedApartmentForPayment as any).sale_info.total_paid / (selectedApartmentForPayment as any).sale_info.sale_price * 100), 100)}%`
                    }}
                  ></div>
                </div>
              </div>

              {(selectedApartmentForPayment as any).sale_info.sale_date && (
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-600">Sale Date</p>
                  <p className="font-semibold text-gray-900">
                    {format(new Date((selectedApartmentForPayment as any).sale_info.sale_date), 'MMMM dd, yyyy')}
                  </p>
                </div>
              )}

              {(selectedApartmentForPayment as any).sale_info.notes && (
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-600 mb-2">Notes</p>
                  <p className="text-gray-900">{(selectedApartmentForPayment as any).sale_info.notes}</p>
                </div>
              )}
            </div>
          </div>
