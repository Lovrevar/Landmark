...
import { Users, Plus, Search, Edit, Trash2, Eye, X, Phone, Mail } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Upravljanje kupcima zemljišta</p>
        </div>
        <button
            ...
            >
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center justify-between text-sm pt-2 border-t border-gray-200">
                  ...
                  <span className="font-bold text-gray-900">€{customer.total_spent?.toLocaleString() || 0}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
