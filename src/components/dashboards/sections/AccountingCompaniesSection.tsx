    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200">
      ...
      <div className="p-6">
        {topCompanies.length === 0 ? (
          <p className="text-gray-500 text-center py-8">{t('dashboards.accounting.no_company_data')}</p>
        ) : (
              ...
              >
                <div className="flex items-center flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">{company.invoiceCount} {t('dashboards.accounting.invoices_label')}</p>
                  </div>
                </div>
